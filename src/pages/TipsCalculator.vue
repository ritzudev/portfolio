<template>
  <div class="transition-all duration-1000 bg-[#C5E4E6] dark:bg-gray-900 pt-5">
    <DarkModeVue />
    <div class="h-[calc(100vh-70px)] flex flex-col justify-center items-center">
      <section
        class="flex flex-col ct:flex-row bg-white dark:bg-slate-600 p-5 rounded-2xl gap-5 transition-all duration-700"
      >
        <div class="flex flex-col gap-4 max-w-sm p-5">
          <div>
            <h4 class="font-bold font-mono opacity-50 dark:opacity-100">
              Bill
            </h4>
            <div class="group">
              <span class="dollar">
          ...
          <div>
            <h4 class="font-bold font-mono opacity-50 dark:opacity-100 py-2">
              Select Tip %
            </h4>
